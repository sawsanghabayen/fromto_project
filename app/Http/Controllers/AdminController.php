...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->view('controlpanel.admins.index', ['admins' => $admins]);
    }
    ...
    public function editAdminPermissions(Request $request, Admin $admin)
    {
        ...
        return response()->view('controlpanel.admins.permissions',['admin' => $admin, 'permissions' => $permissions]);
    }
    ...
    {
        return response()->view('controlpanel.admins.create');
    }
    ...
    {
        return response()->view('controlpanel.admins.edit', ['admin' => $admin]);
    }
    ...
    public function update(Request $request, Admin $admin)
    {
        $validator = Validator($request->all(), [
            ...
            'mobile' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:10,email,' . $admin->id,
