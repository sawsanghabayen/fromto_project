            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->title}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->title_ar}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->content}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$service->content_ar}}</span>
                        </td>
                        @canany([ 'Update-Service' ,'Delete-Service'])
                        ...
                        <td class="pr-0 text-right">
                            ...
                            @endcan
                            @can([ 'Delete-Service'])
                            <a href="#" onclick="performDelete('{{$service->id}}', this)"
